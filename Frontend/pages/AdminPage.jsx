  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-[#0a0a0f] flex items-center justify-center px-6">
      ...
      <div className="relative text-center">
        <h1 className="text-3xl font-extrabold text-[#FD6E59] sm:text-4xl">
        ...
        <button
          ...
          className="mt-6 rounded-full border-2 border-[#FD6E59] bg-white px-6 py-2.5 text-xs font-bold tracking-wide text-black transition-colors hover:bg-gray-100"
        >
          Back
        </button>
      </div>
